      ...
      <body>
        <form {{url_for('chatbotsystem')}} method="POST">
    	 ...
    	 <i class="fas fa-user-circle"></i>
          ...
          <div class="container">
           <label for="ufname"><strong>Hello, Welcome to the college inquiry portal. I am here to help you with questions related to UC</strong></label></br></br>
    	  <label for="ufname"><strong>Choose any of the question from the list below</strong></label></br>
...
def chatbotsystem():
    ...
    if request.method == 'POST' and str(request.form['question']) !="":
        ...
        if(questionasked in "Does the college have a football team?"):
            ChatWindowHTMLMiddle="""
            </br><label for="ufname" style="color:#FF0000;"><strong>"""+questionasked+"""</strong></label></br>
            <label for ="ufname"><strong> Yes! The football team's name is Bearcats. </strong></label></br>
            """
            # answergiven="Yes! The football team's name is Bearcats."
            ...
            <label for ="ufname"><strong> For in-state Ohioans attending UC, the total cost of tuition and living expenses is $28,150. This figure is subjected to change based on the major one chooses to take.</strong></label></br>
            """
            # answergiven = "For in-state Ohioans attending UC, the total cost of tuition and living expenses is $28,150. This figure is subjected to change based on the major one chooses to take."
        elif (questionasked in "Does its have on campus housing?"):
            ChatWindowHTMLMiddle = """
            </br><label for="ufname" style="color:#FF0000;"><strong>""" + questionasked + """</strong></label></br>
            <label for ="ufname"><strong> No! it doesn't have campus housing for graduate students.</strong></label></br>
            """
            # answergiven = "No! it doesn't have campus housing for graduate students."
        else:
            ChatWindowHTMLMiddle = """
            </br><label for="ufname" style="color:#FF0000;"><strong>""" + questionasked + """</strong></label></br>
...
def endchat():
    ...
    Creator Details:<br>
    <label for="ufname"><strong>Neha Reddy, Karnati, karnatny@mail.uc.edu</strong></label></br></br>
    """
